...
# -*- coding: utf-8 -*-
"""
OGGM Glacier Simulations - ERA5 Climate Data
Multi-dataset comparison: ERA5 reanalysis forcing
...
if __name__ == '__main__':
    ...
    for zona in list_region:
        ...
        print(f"\n{'='*70}")
        print(f"PROCESSING CLUSTER: {zona} with ERA5 climate data")
        print(f"{'='*70}\n")
        
        # Output directory for ERA5 results
        salida = '/Users/milliespencer/Desktop/CR2_OGGM_Paper/Output/ERA5/' + zona + '/'
        ...
        compilacion = '_2000_2019_hydro_ERA5_' + zona
