...
# -*- coding: utf-8 -*-
"""
OGGM Validation Script - ERA5 Climate Data
...
# Base directory
output_base = '/Users/milliespencer/Desktop/CR2_OGGM_Paper/Output/ERA5/'
...
if __name__ == '__main__':
    ...
    for zona in list_region:
        ...
        compilacion_zona = salida + 'run_output_2000_2019_hydro_ERA5_' + zona + '.nc'
        ...
        mb_mean['year'] = np.arange(2000, 2020)
        ...
        a_gmb = np.array([(float(gmb_value))/1000]*20)
        a_error = np.array(([(float(gmb_error))/1000]*20))
        ...
        name = 'Annual_mb_' + zona + '_2000-2020.png'
        pathname = salida + name
        
        f = figure()
        ax = f.add_subplot(111)
        plt.plot(mb_mean.year, mb_mean.mb/1000, color="blue", label="OGGM MB")
        plt.plot(years, ([(float(gmb_value))/1000]*20), color="black", label="GMB")
